...
func main() {
	fmt.Println("=== I/O Control Sequence Example ===")
	...
	commands := []*types.Command{
		...
		types.NewCommandBuilder().
			...
			WithComment("Enable digital output 1").
			Build(),
		
		// Set analog output 1 to 3.14V
		types.NewCommandBuilder().
			WithID(2).
			WithType(types.CmdSetAnalogOutput).
			WithParameter("output", 1).
			WithParameter("value", 3.14).
			WithComment("Set analog output 1 to 3.14V").
			Build(),
		
		// Wait for digital input 1 to go high
		types.NewCommandBuilder().
			WithID(3).
			...
			WithComment("Wait for digital input 1 to go high").
			Build(),
		
		// Wait for analog input 1 to reach 2.5V
		types.NewCommandBuilder().
			WithID(4).
			...
			WithComment("Wait for analog input 1 to reach 2.5V").
			Build(),
		...
		// Set digital output 2 to high
		types.NewCommandBuilder().
			WithID(6).
			WithType(types.CmdSetDigitalOutput).
			WithParameter("output", 2).
			WithParameter("value", true).
			WithComment("Enable digital output 2").
			Build(),
		...
		types.NewCommandBuilder().
			...
			WithType(types.CmdSetAnalogOutput).
			WithParameter("output", 1).
			WithParameter("value", 0.0).
			WithComment("Set analog output 1 to 0V").
			Build(),
